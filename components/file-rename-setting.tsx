...
import { useFileRenameSetting } from "@/hooks/use-file-rename-setting"
...
const FileRenameSetting: React.FC<FileRenameSettingProps> = ({
    ...
    return (
        <>
            <h1 className='font-bold text-lg'>File rename settings</h1>
            <p>
            ...
            <Form {...form}>
                <form onSubmit={form.handleSubmit(onSubmit)} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-2 space-y-6">
                    <FormField
                    ...
                    />
                    <Button className="p-4" type="submit">Save</Button>
                </form>
            </Form>
        </>
    )
...
export default FileRenameSetting